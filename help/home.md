...
>[!NOTE]
>
> サポートチケットを送信する前に、[アドビステータス](https://status.adobe.com/jp)サイトでアドビシステムのパフォーマンス、可用性、ソリューションの問題を確認することを考慮します。
...
1. 「**[!UICONTROL サポートチケットを開く]**」を選択すると、ケース作成ページに移動します。このページで、製品名（Audience Manager、Campaign、Target など）、**[!UICONTROL ケースタイトル]**、**[!UICONTROL ケースの説明]**&#x200B;を入力できます。

   ![Experience League の「チケットを開く」](./assets/experience-league-open-ticket.png)

   トラブルシューティングのプロセスを高速化するには、「**[!UICONTROL ケースの説明]**」フィールドに次の情報を追加します。
...
1. ソリューションを選択すると、次の質問が表示され、一部のソリューションには追加のフィールドがあります。
